...
<script language="javascript">
    function delete_id(id) {
        if (confirm('您确定删除吗？')) {
            window.location.href = "<%=path %>/webDeleteComplain/" + id + ".do";
        }
    }


    function update_id(id) {
        window.location.href = "<%=path %>/webUpdateComplain/" + id + ".do";
    }
            ...
            <div class="row">
                ...
                <c:forEach items="${listData}" var="complain">
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF" align="center">
                            <c:if test="${complain.complainstatus!='已处理'}">
                ...
                <TR align="right">
                    <td bgcolor="#FFFFFF" align="center">
                        <form action="" method="post" name="formpage">
                            ...
                            <!--//用于给上面javascript传值-->
                            <input type="hidden" name="jumpurl" value="<%=path%>/webSearchComplain.do?"/>
                            <!--//用于给上面javascript传值-->
