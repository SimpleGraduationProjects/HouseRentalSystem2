                ...
                <div class="col-md-12 " style="padding-left:100px;margin-top: 60px">
                    ...
                    <div class="course">
                        <div class="lay4">
                            ...
                            <form  class="form-horizontal"  action="<%=path %>/webSaveComplain.do" name="formAdd" method="post">

                                <input type="hidden" name="complainstatus" value="未处理">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-4"><input required="required" type="text" name="info" size="20"/>
                                    </div>
                                </div>
