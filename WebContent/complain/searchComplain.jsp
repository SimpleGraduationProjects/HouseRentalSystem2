...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default wk-panel wk-table-tools-panel">
            ...
            <form action="<%=basePath%>searchComplain.do" method="POST"
    ...
    <div class="row">
            ...
            <div class="panel panel-default  wk-panel">
                <table class="table table-striped table-hover">
                    ...
                    <tr class="title">
                        ...
                        <th data-halign="center" data-align="center">投诉内容</th>
                        <th data-halign="center" data-align="center">选项</th>
                    </tr>
                    </thead>
                    <c:forEach items="${listData}" var="complain">
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF" align="center">
                            <fmt:formatDate value="${complain.createTime}" pattern=" MM月dd日 E"/>
                        </td>
                        <td bgcolor="#FFFFFF" align="center">
                                ${complain.title}
                        </td>
                        ...
                        <td bgcolor="#FFFFFF" align="center">
                            <input type="button" class="btn btn-primary btn-sm" value="处理"
                                   onclick="update_id(${complain.id})"/>
                            <input type="button" class="btn btn-primary btn-sm" value="删除"
                                   onclick="delete_id(${complain.id})"/>
            ...
            <TR align="right">
                <td bgcolor="#FFFFFF" align="center">
                    <form action="" method="post" name="formpage">
                        ...
                        <!--//用于给上面javascript传值-->
                        <input type="hidden" name="jumpurl" value="<%=path%>/searchComplain.do?"/>
                        <!--//用于给上面javascript传值-->
        ...
        <script language="javascript">
            function delete_id(id) {
                if (confirm('您确定删除吗？')) {
                    window.location.href = "<%=path %>/deleteComplain/" + id + ".do";
                }
            }


            function update_id(id) {
                window.location.href = "<%=path %>/updateComplain/" + id + ".do";
            }
