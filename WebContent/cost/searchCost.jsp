...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default wk-panel wk-table-tools-panel">
            ...
            <form action="<%=basePath%>searchCost.do" method="POST"
            ...
            <TR align="right">
                <td bgcolor="#FFFFFF" align="center">
                    <form action="" method="post" name="formpage">
                        ...
                        <!--//用于给上面javascript传值-->
                        <input type="hidden" name="jumpurl" value="<%=path%>/searchCost.do?"/>
                        <!--//用于给上面javascript传值-->
    ...
    <script language="javascript">
        function delete_id(id) {
            if (confirm('您确定删除吗？')) {
                window.location.href = "<%=path %>/deleteCost/" + id + ".do";
            }
        }


        function update_id(id) {
            window.location.href = "<%=path %>/updateCost/" + id + ".do";
        }
