...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default wk-panel ">
            ...
            <form action="<%=path %>/editRoom/${room.id}.do" name="formAdd" method="post"
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="form-inline">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="wk-select" name="customer_id" id="customer_id">
                                        <option value="${room.customer_id}">${room.customerName}
                                        </option>
                                        <option value="0">空置
                                        </option>
                            ...
                            <div class="form-group">
                                <label class="control-label wk-filed-label">楼名称：
                                </label>
                                <div class="input-group">


                                    <select class="wk-select" name="floorId" id="floorId">
                                        <option value="${room.floorId}">${room.floorName}</option>
                            ...
                            <div class="form-group">
                                <label class="control-label wk-filed-label">户型：
                                </label>
                                <div class="input-group">
                                    <input class="form-control wk-long-2col-input" required="required" type="text"
                                           name="name"
                        ...
                        <textarea name="info"
                                  style="margin-top:5px; width:300px; height:50px;">${room.info}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
