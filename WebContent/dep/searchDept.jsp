...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default wk-panel wk-table-tools-panel">
            ...
            <form action="<%=basePath%>searchDept.do" method="POST" onsubmit="return check()">
                ...
                <TR align="right">
                    <TD>
                        <form action="" method="get" name="formpage">
                            ...
                            <!--//用于给上面javascript传值-->
                            <input type="hidden" name="jumpurl" value="searchDept.do?"/>
                            <!--//用于给上面javascript传值-->
...
<script>
    ...
    function delete_id(id) {
        ...
        if (id != "") {
            ...
            $("#deleteBtnOK").on("click", function () {
                location.href = "<%=basePath%>deleteDept/" + id + ".do";
            });
        }
    }
    ...
    function update_id(id) {
        ...
        if (id != "") {
            location.href = "<%=basePath%>updateDept/" + id + ".do";
        }
    }
